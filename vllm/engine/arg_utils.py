...
class EngineArgs:
    ...
    allowed_media_domains: Optional[list[str]] = (
        ModelConfig.allowed_media_domains
    )
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument(
            "--logprobs-mode", **model_kwargs["logprobs_mode"]
        )
        model_group.add_argument(
        ...
        model_group.add_argument(
            "--config-format", **model_kwargs["config_format"]
        )
        ...
        model_group.add_argument(
            "--pooler-config", **model_kwargs["pooler_config"]
        )
        model_group.add_argument(
        ...
        parallel_group.add_argument(
            "--enable-dbo", **parallel_kwargs["enable_dbo"]
        )
        parallel_group.add_argument(
    ...
    def create_engine_config(
        ...
        assert (
            self.tensor_parallel_size % self.decode_context_parallel_size == 0
        ), (
