...
class EngineCore:
    ...
    def __init__(
        ...
        self.collective_rpc(
            "initialize_cache", args=(num_gpu_blocks, num_cpu_blocks)
        )
        ...
        self.request_block_hasher: Optional[
...
class DPEngineCoreProc(EngineCoreProc):
        ...
        if request_type == EngineCoreRequestType.START_DP_WAVE:
            ...
            if exclude_eng_index != self.engine_index and (
                ...
                if not self.engines_running:
                    logger.debug(
                        "EngineCore starting idle loop for wave %d.", new_wave
                    )
    ...
    def reinitialize_distributed(
        ...
        if (
            ...
            logger.info(
                "Distributed environment reinitialized for DP rank %s",
                self.dp_rank,
            )
...
class DPEngineCoreActor(DPEngineCoreProc):
    ...
    def __init__(
        ...
        super().__init__(
            vllm_config, local_client, "", executor_class, log_stats
        )
